...
path BQ=(0,0)--(0,1)--(-1,1)--(-1,0)--cycle;
path ABQ=(0,0)--(0,1)--(-2,1)--(-2,0)--cycle;
...
label("$\mathbf B$",(5.40,1.55),N,textPen);

drawLocalAxes(O2);
filldraw(shift(O2.x,O2.y)*BQ,c2Fill10,c2+linewidth(0.8pt));
dot(O2,black+2.4pt);

draw((11.10,1.45)--(12.10,1.45),axisPen,axisArrow);
label("$\mathbf A$",(11.60,1.55),N,textPen);

drawLocalAxes(O3);
filldraw(shift(O3.x,O3.y)*ABQ,c5Fill18,c5+linewidth(0.8pt));
dot(O3,black+2.4pt);
